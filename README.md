...
适合在作品集中展示我在 **Unity 架构设计、系统抽象、玩法迭代** 方面的能力。
...
如果你是面试官或评审，我建议从以下角度查看这个项目：

1. **系统边界清晰度**：战斗、计分、规则、道具逻辑是否低耦合；
2. **可扩展性**：新增 Joker / Boss 是否只需新增数据与局部逻辑；
3. **设计思路**：如何通过规则冲突（Boss）与资源分配（商店）创造策略张力。
...
如果你希望我继续完善这个项目，也欢迎直接提出方向（例如“强化 Boss 设计”或“补一套存档系统”）。
